    ...
    return (
        <div className={s.user}>
            <div className={s.avatar}>
                <NavLink to={`/profile/${props.userId}`}><img src={props.photos.small ? props.photos.small : unknownAvatar}
                                                      alt=""/></NavLink>
            </div>
            ...
            {props.isAuth?
                props.followed ? <button className={s.button} disabled={props.buttonInProgress.some(id => id === props.userId)}
                                  onClick={() => {
